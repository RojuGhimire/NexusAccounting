...
const Footer: React.FC = () => {
  ...
  return (
    <motion.div
      className="bg-white dark:bg-zinc-800 py-8 px-4"
      initial="hidden"
      animate="visible"
      variants={containerVariants}
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 text-zinc-800 dark:text-zinc-200">
        <motion.div className="col-span-1" variants={itemVariants}>
          <img src="/logo.png" alt="Nexus Logo" className="mb-4" />
          <p className="text-sm">
            In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content. Lorem ipsum may be used as a placeholder before final copy is available.
          </p>
        </motion.div>
        <motion.div className="col-span-1" variants={itemVariants}>
          <h3 className="text-lg font-semibold text-teal-600 dark:text-teal-400 mb-4">Company</h3>
